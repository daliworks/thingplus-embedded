...
4. 게이트웨이 ID로 사용할 값 : MAC, IMEI or UUID
   ...
   (위 세개 사항을 사용할 수 없을 경우 별도로 연락 바랍니다.)
5. 전송주기(최소 60초) :
...
```
1. 벤더 이름 : OPEN SOURCE HARDWARE
2. 게이트웨이 이름 : Beaglebone Green - Developer
...
- 디바이스 정보 
1. 디바이스 이름 : Grove Starter Kit for Beaglebone Green v1.0
2. 디스커버기능 사용 여부 : Yes
3. 센서정보
